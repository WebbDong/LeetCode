package com.dong.leetcode.easy.multithreading;

/**
 * 红绿灯路口
 *      这是两条路的交叉路口。第一条路是 A 路，车辆可沿 1 号方向由北向南行驶，也可沿 2 号方向由南向北行驶。第二条路是 B 路，
 *      车辆可沿 3 号方向由西向东行驶，也可沿 4 号方向由东向西行驶。
 *
 ...
 *
 * 开始时，A 路上的绿灯亮起，B 路上的红灯亮起。当一条路上的绿灯亮起时，所有车辆都可以从任意两个方向通过路口，直到另一条路上的绿灯亮起。
 * 不同路上的车辆不可以同时通过路口。
 *
